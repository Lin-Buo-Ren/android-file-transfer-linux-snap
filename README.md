# Unofficial Snap Packaging for Android File Transfer for Linux
This is the unofficial snap packaging for Android File Transfer for Linux, [Snaps are universal Linux packages](https://snapcraft.io).

Refer [snap/README.md](snap/README.md) for user-oriented information.

## Remaining Tasks
Snapcrafters ([join us](https://forum.snapcraft.io/t/join-snapcrafters/1325)) are working to land snap install documentation and the [snapcraft.yaml](https://github.com/Lin-Buo-Ren/snapcrafters-template-plus/blob/master/snap/snapcraft.yaml) upstream so Android File Transfer for Linux can authoritatively publish future releases.
...
## Upstream
| [![Vladimir'a avatar](http://gravatar.com/avatar/339a53d4c90afb9ff27a6ec6fb6b5813?s=128)](https://github.com/whoozle) |
| :-: |
| [Vladimir](https://github.com/whoozle) |
